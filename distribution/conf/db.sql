...
-- ----------------------------
-- Table structure for y_pan_file
-- ----------------------------
DROP TABLE IF EXISTS `y_pan_file`;

CREATE TABLE `y_pan_file`
(
...
-- ----------------------------
-- Table structure for y_pan_share
-- ----------------------------
DROP TABLE IF EXISTS `y_pan_share`;
CREATE TABLE `y_pan_share`
(
...
-- ----------------------------
-- Table structure for y_pan_share_file
-- ----------------------------
DROP TABLE IF EXISTS `y_pan_share_file`;
CREATE TABLE `y_pan_share_file`
(
...
-- ----------------------------
-- Table structure for y_pan_user
-- ----------------------------
DROP TABLE IF EXISTS `y_pan_user`;
CREATE TABLE `y_pan_user`
(
...
-- ----------------------------
-- Table structure for y_pan_user_file
-- ----------------------------
DROP TABLE IF EXISTS `y_pan_user_file`;
CREATE TABLE `y_pan_user_file`
(
...
-- ----------------------------
-- Table structure for y_pan_user_search_history
-- ----------------------------
DROP TABLE IF EXISTS `y_pan_user_search_history`;
CREATE TABLE `y_pan_user_search_history`
(
    `id`             bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `user_id`        bigint(0) NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Table structure for y_pan_file_chunk
-- ----------------------------

DROP TABLE IF EXISTS `y_pan_file_chunk`;
CREATE TABLE `y_pan_file_chunk`
(
...
-- ----------------------------
-- Table structure for y_pan_error_log
-- ----------------------------

DROP TABLE IF EXISTS `y_pan_error_log`;
CREATE TABLE `y_pan_error_log`
(
    `id`          bigint                           NOT NULL AUTO_INCREMENT COMMENT '主键',
