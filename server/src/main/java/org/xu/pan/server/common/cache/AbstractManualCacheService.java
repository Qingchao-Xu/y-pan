package org.xu.pan.server.common.cache;
...
public abstract class AbstractManualCacheService<V> implements ManualCacheService<V> {
    ...
    private Object lock = new Object(); // 本地锁解决缓存击穿问题
    ...
    public Cache getCache() {
        if (Objects.isNull(cacheManager)) {
            throw new YPanBusinessException("the cache manager is empty!");
        }
