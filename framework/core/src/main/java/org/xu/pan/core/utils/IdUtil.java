...
public class IdUtil {
    ...
    public static Long decrypt(String decryptId) {
        if (StringUtils.isNotBlank(decryptId)) {
            ...
            throw new YPanBusinessException("AES128Util.aesDecode fail");
        }
        throw new YPanBusinessException("the decryptId can not be empty");
    }
    ...
    public static List<Long> decryptIdList(String decryptIdStr) {
        ...
        List<String> decryptIdList = Splitter.on(YPanConstants.COMMON_SEPARATOR).splitToList(decryptIdStr);
    ...
    public static void main(String[] args) {
        System.out.println(encrypt(1834118471571607552L));
